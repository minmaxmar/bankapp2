...
// NewBankapp2API creates a new Bankapp2 instance
func NewBankapp2API(spec *loads.Document) *Bankapp2API {
	return &Bankapp2API{
...
/*Bankapp2API bankapp2 */
type Bankapp2API struct {
	spec            *loads.Document
...
func (o *Bankapp2API) UseRedoc() {
	o.useSwaggerUI = false
}

// UseSwaggerUI for documentation at /docs
func (o *Bankapp2API) UseSwaggerUI() {
	o.useSwaggerUI = true
}

// SetDefaultProduces sets the default produces media type
func (o *Bankapp2API) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *Bankapp2API) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *Bankapp2API) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *Bankapp2API) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *Bankapp2API) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *Bankapp2API) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *Bankapp2API) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the Bankapp2API
func (o *Bankapp2API) Validate() error {
...
func (o *Bankapp2API) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *Bankapp2API) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
	return nil
}

// Authorizer returns the registered authorizer
func (o *Bankapp2API) Authorizer() runtime.Authorizer {
	return nil
}

// ConsumersFor gets the consumers for the specified media types.
// MIME type parameters are ignored here.
func (o *Bankapp2API) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
// MIME type parameters are ignored here.
func (o *Bankapp2API) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *Bankapp2API) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the bankapp2 API
func (o *Bankapp2API) Context() *middleware.Context {
	if o.context == nil {
...
func (o *Bankapp2API) initHandlerCache() {
...
func (o *Bankapp2API) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *Bankapp2API) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *Bankapp2API) RegisterProducer(mediaType string, producer runtime.Producer) {
	o.customProducers[mediaType] = producer
}

// AddMiddlewareFor adds a http middleware to existing handler
func (o *Bankapp2API) AddMiddlewareFor(method, path string, builder middleware.Builder) {
	um := strings.ToUpper(method)
	if path == "/" {
		path = ""
	}
