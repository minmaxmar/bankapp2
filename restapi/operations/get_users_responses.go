...
func (o *GetUsersDefault) WithPayload(payload *models.ErrorResponse) *GetUsersDefault {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get users default response
func (o *GetUsersDefault) SetPayload(payload *models.ErrorResponse) {
	o.Payload = payload
}
